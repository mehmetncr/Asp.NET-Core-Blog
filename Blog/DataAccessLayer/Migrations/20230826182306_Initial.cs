        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbautDetails1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AbautDetails2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AbautImage1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AbautImage2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AbautMapLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AbautStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abouts", x => x.AbautID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ratyings", x => x.RaytingID);
                });
